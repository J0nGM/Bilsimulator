...
private:
    ...
    static constexpr float enemy_spawn_height_{7.5f};
    static constexpr float enemy_hit_radius_{20.0f};
    static constexpr float enemy_tank_push_distance_{20.0f};
    static constexpr float enemy_bullet_speed_{150.0f};
    static constexpr float enemy_tank_push_force_{2.0f};
